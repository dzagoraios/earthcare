...
MongoClient.connect(url3, function(err) {
	if(err) {
		...
		dbo.collection("collectionName").deleteMany(,{}, function(err1, res){ //Delete from table
		//dbo.collection("collectionName").deleteMany(,{column2: 22}, function(err1, res){  //delete from testtable where column2=22
			if(err1){
